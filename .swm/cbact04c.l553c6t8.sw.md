...
M --> P["Get next recored"]

```

<SwmSnippet path="/app/cbl/CBACT04C.cbl" line="180" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1hd3MtbWFpbmZyYW1lLW1vZGVybml6YXRpb24tY2FyZGRlbW8lM0ElM0FTd2ltbS1EZW1v" repo-name="aws-mainframe-modernization-carddemo">
...
<SwmSnippet path="/app/cbl/CBACT04C.cbl" line="188" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1hd3MtbWFpbmZyYW1lLW1vZGVybml6YXRpb24tY2FyZGRlbW8lM0ElM0FTd2ltbS1EZW1v" repo-name="aws-mainframe-modernization-carddemo">

---

Then it begins a loop that continues until the end of the transaction category balance file. Within this loop, it reads the next transaction category balance record and checks if the account ID has changed since the last record processed. If they're different, it means we've moved to processing a new account.

If we've moved to a new account and this isn't the first record being prossessed, we need to update the previous account with the accumulated interest.
...
<SwmSnippet path="/app/cbl/CBACT04C.cbl" line="200" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1hd3MtbWFpbmZyYW1lLW1vZGVybml6YXRpb24tY2FyZGRlbW8lM0ElM0FTd2ltbS1EZW1v" repo-name="aws-mainframe-modernization-carddemo">
...
<SwmSnippet path="/app/cbl/CBACT04C.cbl" line="462" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1hd3MtbWFpbmZyYW1lLW1vZGVybml6YXRpb24tY2FyZGRlbW8lM0ElM0FTd2ltbS1EZW1v" repo-name="aws-mainframe-modernization-carddemo">
...
<SwmSnippet path="/app/cbl/CBACT04C.cbl" line="467" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1hd3MtbWFpbmZyYW1lLW1vZGVybml6YXRpb24tY2FyZGRlbW8lM0ElM0FTd2ltbS1EZW1v" repo-name="aws-mainframe-modernization-carddemo">
